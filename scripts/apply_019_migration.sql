-- Safe re-apply of 019_lead_agent_v2.sql (idempotent)
...
-- Remove mission_id from leads before dropping missions (FK constraint)
ALTER TABLE public.leads DROP COLUMN IF EXISTS mission_id;
